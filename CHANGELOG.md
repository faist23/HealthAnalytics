...
- **A week off because you're hurt no longer counts as a taper.** The card fired on two signals — volume down, HRV recovering — which is what a race taper looks like and equally what a crash, the flu, or a week of work travel looks like. It now also checks the thing that actually separates them: a taper cuts volume but keeps the hard efforts, while stopping drops both. If you haven't trained at all in the last week, it won't call that a taper regardless. If your sessions are still there but got easy, it won't either. Riders with a power meter or heart-rate strap get the full check; everyone else gets the "did you train at all" half.
- **The app no longer tells you that you're tapering when it can't know that.** The card fired on two signals: training volume down, HRV recovering. That's what a race taper looks like — and it's equally what a crash, a bout of flu, or a week of work travel looks like, because HRV rises on rest either way. So a rider who'd just been forced off the bike was told "Taper underway. Trust the process; fitness is locked in. Peak form expected in 14 days." Every one of those screens now reports what was measured — "Volume down 41% and HRV recovering" — and makes the peak-form projection conditional on the drop having been planned. The card is called **Load Dropping**. If it wasn't your choice, it says the fitness you built is still there, which is the true and more useful thing to hear.
